...
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		//Exercise 19
		//import data after sample data in order to avoid conflicts with cms content
		importImpexFile(context, "/bookstoreinitialdata/import/sampledata/contentCatalogs/bookstoreContentCatalog/btg-data.impex");
		//Synchronize content catalog
		getSampleDataImportService().synchronizeContentCatalog(this, context, BOOKSTORE, true);
	}
