...
public class DefaultBookstorepaymentService implements BookstorepaymentService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBookstorepaymentService.class);
	...
	{
		return DefaultBookstorepaymentService.class.getResourceAsStream("/bookstorepayment/sap-hybris-platform.png");
	}
