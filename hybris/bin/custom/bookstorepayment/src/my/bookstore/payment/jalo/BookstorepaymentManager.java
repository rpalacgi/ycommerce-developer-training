...
/**
 * This is the extension manager of the Bookstorepayment extension.
 */
public class BookstorepaymentManager extends GeneratedBookstorepaymentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BookstorepaymentManager.class);
	 ...
	 */
	public static BookstorepaymentManager getInstance()
	{
		return (BookstorepaymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BookstorepaymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BookstorepaymentManager() // NOPMD 
	{
		LOG.debug("constructor of BookstorepaymentManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of BookstorepaymentManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of BookstorepaymentManager called, current tenant: {}", getTenant().getTenantID());
	}
