...
import my.bookstore.storefront.util.CSRFHandlerInterceptor;
import my.bookstore.storefront.util.CSRFTokenManager;
...
public class CSRFHandlerInterceptorTest extends ServicelayerTest
{
	...
	private static final String SESSION_CSRF_ATTRIBUTE = "my.bookstore.storefront.util.CSRFTokenManager.tokenval";
